 function [SEMA, ECC, INC, PHA, w]=ap2em1(Au, PHIu, Av, PHIv, plot_demo)
 ...
 wp = (u+1i*v)/2; % for anticlockwise circles
 wm = conj(u-1i*v)/2; % for clockwise circles
 ...
 SEMI = Wp-Wm; % Semin Minor Axis, or minimum speedu
 ...
 % [-pi, 0) to [0, 2*pi), which at least is my convention.
