...
% coefM = ut_solv ( TM, ZM, [], lat,{'M2','S2','K1','O1'},'NoTrend');  
%              
...
coefR = coefS;
coefR.A(coefS.diagn.SNR < SNRmin) = 0; 
coefR.A_ci(coefS.diagn.SNR < SNRmin) = 0;
coefR.g(coefS.diagn.SNR < SNRmin) = 0; 
coefR.g_ci(coefS.diagn.SNR < SNRmin) = 0;
week = 1/(24*7); % One week frequency
coefR.A(coefS.aux.frq < week) = 0; coefR.A_ci(coefS.diagn.SNR < week) = 0;
coefR.g(coefS.aux.frq < week) = 0; coefR.g_ci(coefS.diagn.SNR < week) = 0;
