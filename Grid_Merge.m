...
% contained in the mat files  mesh1 and mesh2. Assumes the triangulations 
% are either overlapping or very close to overlapping and of similar
% refinement.
% Uses a simplified form of the algorithm described in the pulbication
% "Connectivity Oblivious Merging of Triangulations" by Silva et al.,2012. 
